...
import like.like_main as main_process
...
# 글로벌 변수
order_service = config['item']['like']
...
def fetch_order() -> bool:
    # 주문 중복체크
    is_dupl_order = common.dupl_check(int(config['api']['like_service']), order_service, order_log_path)
    if is_dupl_order:
        return
